defmodule FirebnbWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FirebnbWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FirebnbWeb.Gettext, "errors", msg, opts)
    end
  end
